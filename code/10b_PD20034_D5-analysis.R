...
# Import data
h5_file = paste0("../data/gexp/ALLO_Sample34-Day5_rna_filtered_feature_bc_matrix.h5")
...
# Append kite counts
so_filt$HHV6 <- import_from_kite(unique(fread(paste0("../data/feature_counts/ALLO_Sample34-Day5_HHV6b.kb.txt.gz"))),
...
cowplot::ggsave2(cowplot::plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, nrow = 4), 
                 width = 15, height = 12, filename = paste0("../plots/Sample34-Day5-custom.png"))
...
write.table(df, file = "../output/Sample34-Day5-correlation.tsv", 
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)
write.table(permdf, file = "../output/Sample34-Day5-permuted.tsv", 
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)
