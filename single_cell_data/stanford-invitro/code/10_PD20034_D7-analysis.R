...
# Append kite counts
so_filt$HHV6 <- import_from_kite(unique(fread(paste0("../data/feature_counts/ALLO_Sample34-Day7_HHV6b.kb.txt.gz"))),
...
cowplot::ggsave2(cowplot::plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, nrow = 4), 
                 width = 15, height = 12, filename = paste0("../plots/Sample34-Day7-custom.png"))
...
write.table(df, file = "../output/Sample34-Day7-correlation.tsv", 
